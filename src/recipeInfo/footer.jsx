...
<footer style={{ backgroundColor: '#FBF0F7' ,border: '1px solid #e0e0e0', marginTop: '50px', }} className="fixed bottom-0 left-0 z-20 w-full p-4 bg-[#FAD8DB] border-t border-gray-100 shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800 dark:border-gray-600">
